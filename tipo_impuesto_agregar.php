    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header">Registar Tipo de Impuesto 
                            <a href="tipo_impuesto_index.php" 
                ...
                <div class="row">
                    <div class="col-lg-12">                                         
                        <div class="panel-body">
                            <form action="tipo_impuesto_control.php" method="post" 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" required="" placeholder="Ingrese nombre del tipo de impuesto"  
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" required="" placeholder="Ingrese nombre del tipo de impuesto"  
                                               class="form-control" name="vporcentaje" id="nom"
                                               >
                                    </div>
                                </div>
