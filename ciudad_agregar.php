    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header">Registar Ciudad 
                            <a href="ciudad_index.php" 
                ...
                <div class="row">
                    <div class="col-lg-12">                                         
                        <div class="panel-body">
                            <form action="ciudad_control.php" method="post" 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" required="" placeholder="Ingrese nombre de la ciudad"  
