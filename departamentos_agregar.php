    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header">Agregar departamento 
                            <a href="departamentos_index.php" 
                ...
                <div class="row">
                    <div class="col-lg-12">                                         
                        <div class="panel-body">
                            <form action="departamentos_control.php" method="post" 
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Descripcion o nombre</label>
                                    <div class="col-md-5">
                                        <input type="text" required="" placeholder="Ingrese la Descripcion o nombre"  
                                               class="form-control" name="vdescripcion" id="nom"
                                               >
                                    </div>
                                </div>
