        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-primary">
                            ...
                            $ventas = consultas::get_datos
                                            ("select * from v_ventas where id_venta=" .
                                            $_REQUEST['vcod'] . " order by id_venta asc");
                            ?>
                ...
                <div class="row">       
                    <div class="col-md-12">
                        <div class="panel-body">
                            <form action="detventas_control.php" method="post" 
