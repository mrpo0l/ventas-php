    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header">Registar Tipo de compronate 
                            <a href="tipo_comprobante_index.php" 
                ...
                <div class="row">
                    <div class="col-lg-12">                                         
                        <div class="panel-body">
                            <form action="tipo_comprobante_control.php" method="post" 
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Tipo de comprobante</label>
                                    <div class="col-md-5">
                                        <input type="text" required="" placeholder="Ingrese el nombre del tipo de comprobante"  
